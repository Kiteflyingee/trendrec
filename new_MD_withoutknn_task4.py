...
def massDiffisionForOne(train, user, udegree, idegree, _lambda=1):
    '''
...
if __name__ == '__main__':
    ...
    scores = []
    # result_path = './result/delicious/md_delicious_full_result.csv'
    ...
    filepath = r'./data/movielens.pkl'
    # score_filepath = 'temp/md_amazon_noknn_1.pkl'
    # score_filepath = 'temp/md_amazon_noknn_1.pkl'
    # score_filepath = 'temp/task4_md_movielens.pkl'
    score_filepath = 'temp/task3_md_movielens_noknn_2.pkl'
    # score_filepath = 'temp/task3_md_movielens_noknn_1.pkl'
    # score_filepath = 'temp/mdnetflix_noknn_3.pkl'
    ...
    total_item_score_sub1 = exp(-1.0,train)
    total_item_score_plus1 = exp(1.0,train)
    total_item_score = np.zeros(train.shape[1], dtype=np.float64)
    # total_item_score = total_item_score_sub1 / total_item_score_plus1
    # 重新使用减法
    total_item_score = total_item_score_sub1 - total_item_score_plus1
