...
class UserCF:
    ...
    def recommend(self, uid, Nitemset):
        ...
        sorted_sim = sorted(
            ...
            sim_list.items(), key=lambda x: x[1], reverse=True)
...
def main(our_lambda=1,data_file=r'./data/movielens_data.pkl',recommend_score_file=r'./temp/cf_score.pkl', recommend_score=None):
    ...
    if os.path.exists(recommend_score_file):
        ...
        recommend_score = cf.cf_train(Nitemset)
...
if __name__ == "__main__":
    ...
    # recommend_score_file = r'./temp/movielens_cosineknn_post1011211.pkl'
    # resultfile = "./result/movielens/movielens_cosineknn_task1.txt"

    # data_file = "./data/delicious/delicious5k_rerank.pkl"
    # recommend_score_file=r'./temp/delicious_5k_small_k1.pkl'
    # resultfile = "./result/delicious/delicious_5k_task1cf_k2.txt"
    ...
    # recommend_score_file = r'./temp/netflixcfknn_718.pkl'
    # resultfile = "./result/netflix/netflixcfknn_718.txt"


    data_file = './data/Amazon/amazon_5k.pkl'
    recommend_score_file = r'./temp/amazon5nok4.pkl'
    resultfile = "./result/Amazon/task1_amazon5k_nok2.txt"
