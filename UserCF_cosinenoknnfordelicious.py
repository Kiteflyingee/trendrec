...
if __name__ == "__main__":
    ...
    # resultfile = "./result/movielens/movielens_cosineknn_post111000.txt"
    ...
    # resultfile = "./result/netflix/netflixcfnoknn.txt"

    data_file = './data/delicious/delicious5k.pkl'
    recommend_score_file = r'./temp/delicious5kk.pkl'
    resultfile = "./result/delicious/delicious5k_k.txt"
