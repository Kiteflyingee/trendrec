...
def get_item_score(user_degree, recommend_score, item_len, our_lambda=LAMBDA):
    '''
    获得训练集的所有item的得分
    Return:
...
def main(k=1,user_sim = None ,data_file=r'./data/movielens_data.pkl'):
    ...
    newtest = getTestset(test, k)
    test_item_degree = get_test_degree(newtest)
...
if __name__ == "__main__":
    ...
    # resultfile = "./result/movielens/ml_k_task3_lambda1.txt"

    # data_file = "./data/delicious/delicious5k_rerank.pkl"
    # resultfile = "./result/delicious/task3_cf_delicious_5k_lambda1.txt"
    # data_file = "./data/Amazon/amazon_5k.pkl"
    # resultfile = "./result/Amazon/task3_cf_amazon_5k_lambda0.txt"
    # recommend_score_file = r'./temp/amazon_5k.pkl'

    data_file = "./data/netflix.pkl"
    # recommend_score_file = r'./temp/netflixcfnoknn.pkl'
    resultfile = "./result/netflix/netflix_k_task3_lambda0.txt"
    ...
    # resultfile = "./result/Amazon/amazon5knok.txt"
    ...
    for _time in TESTTIME:
        # 因为range的范围是10倍，这里还原
        _time = 0.1 * _time
        corr_score,recommend_score,user_sim= main(k=_time, user_sim=user_sim,data_file=data_file)
        corr_score_list.append(corr_score)
        
    corr_score_arr = np.zeros((len(TESTTIME), 10), np.float64)
