...
if __name__ == "__main__":
    ...
    recommend_score_file = r'./temp/movielens_jaccard_noknn.pkl'
    resultfile = "./result/movielens/movielens_jaccardwithoutknn.txt"
    ...
    for p1 in frange(-1.0, 1.01, 0.1):
        corr_score,recommend_score = main(k=1000, our_lambda=p1, data_file=data_file,\
