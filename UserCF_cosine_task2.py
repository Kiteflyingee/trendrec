...
if __name__ == "__main__":
    ...
    # resultfile = "./result/movielens/movielens_50-500_task2.txt"

    data_file = "./data/delicious/delicious5k_rerank.pkl"
    recommend_score_file=r'./temp/delicious_5k_1.pkl'
    resultfile = "./result/delicious/task2_cf_delicious_5k50-500.txt"
    # data_file = "./data/Amazon/amazon_5k.pkl"
    # recommend_score_file = r'./temp/amazon_5k.pkl'
    # resultfile = "./result/Amazon/amazon_5k_task2.txt"

    # data_file = "./data/netflix.pkl"
    # recommend_score_file = r'./temp/netflixcfnoknn.pkl'
    # resultfile = "./result/netflix/netflixcf_task2_50-500.txt"
    ...
    # resultfile = "./result/Amazon/task2_amazon5kcfk50-500.txt"


    corr_score_list = []
    kneibor = range(50, 501,50 )
    user_sim = None
    for p1 in kneibor:
        corr_score,recommend_score,user_sim= main(k=p1, user_sim=user_sim,data_file=data_file)
        corr_score_list.append(corr_score)
        
    corr_score_arr = np.zeros((len(kneibor), 10), np.float64)
